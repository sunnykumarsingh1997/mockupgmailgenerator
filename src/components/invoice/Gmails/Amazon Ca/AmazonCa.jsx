...
export default function AmazonCa() {
  ...
  const handleFillAll = (jsonString) => {
    try {
      ...
      setOrderNo(data.tra1 || "702-1234567-1234567");
  ...
  return <>
    ...
    <Preview title="PREVIEW AMAZON Ca FORM" />
    ...
    <div className="amazonDE-gmail-form" ref={invoiceRef}>
      ...
      <div className="amazon-mail-inner-content">
        ...
        <div class="amazon-gmail-from-to flex ">
          <p>
            <b>Amazon.Ca</b> &lt;payments-messages@amazon.ca&gt;
          </p>
        ...
        <div className="amazon-gmail-content">
          ...
          Greetings from Amazon.ca.<div className="amazon-spacer" />
          ...
          * to your {card} Credit Card ending with {cardLast}]: {formatWithCommas(amount)} INR
          ...
          <div className="amazon-spacer" />
          <p className="amazonDE-blue">http://www.amazon.ca/gp/help/customer/display.html?nodeld=504874</p>
          <div className="amazon-spacer" />
          Thank you for shopping at Amazon.ca.
          <div className="amazon-spacer" />
          Sincerely,
          <div className="amazon-spacer" />
          Amazon.ca Customer Service <br />
          <p className="amazonDE-blue">http://www.amazon.ca</p>
        </div>
      </div>
